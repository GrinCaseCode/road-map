...
if ( $(this).scrollTop() > 0 && $menu.hasClass("default") ){
  ...
  {
    if ($(window).width() < 992) { 
      $(".title-small_footer").click(function() {
        $(this).toggleClass("active");
        $(this).siblings(".footer__info").slideToggle(200);
      });
    }
  }
	...
	$('.slider-wrapper').each(function() {
        ...
        var $slider = $sliderWrapper.find('.slider-reviews');
	...
	$(".directions .btn-main_more").click(function(e) {
		e.preventDefault();
		if ($(".directions .row_main > div:nth-child(n+7)").is(":hidden")) {
			$(".directions .row_main > div:nth-child(n+7)").slideDown(200);
			$(this).html("Свернуть");
		} else {
			$(".directions .row_main > div:nth-child(n+7)").slideUp(200);
			$(this).html("Показать все направления");
		}
	});
